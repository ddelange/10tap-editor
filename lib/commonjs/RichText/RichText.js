...
const RichText = ({
  ...
  const sourceHtml = (0, _react.useMemo)(() => {
    if (editor.DEV) return undefined;
    const baseHtml = editor.customSource || _editorHtml.editorHtml;
    const initJS = (0, _utils2.getInjectedJSBeforeContentLoad)(editor);
  ...
  return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, editor.autofocus && _reactNative.Platform.OS === 'android' && /*#__PURE__*/_react.default.createElement(_reactNative.TextInput, {
    autoFocus: true,
